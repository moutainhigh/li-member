...
@Data
@ApiModel(value = "单个卡券含优惠券响应(CouponTaskDetailsResponse)")
public class CouponTaskDetailsResponse {
   ...
   * 渠道
   */
  @ApiModelProperty(value = "渠道:0为全渠道，1为广州店，2为上海店")
  private List<Integer> channelList;

  @ApiModelProperty(value = "参与的sku列表")
  private List<CouponTaskSku> couponTaskSkus;

  @ApiModelProperty(value = "赠品列表")
  private List<CouponTaskGift> couponTaskGifts;
